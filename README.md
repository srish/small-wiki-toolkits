...
For each toolkit, there is a link to view the editable version on Google Slides and the PDF version with detailed notes for trainers via Google Drive. You can copy, modify, and re-distribute these toolkits. If you want to contribute a new kit or help improve an existing one, file an issue in this repository and let's discuss it there. 
